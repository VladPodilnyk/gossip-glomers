...
- [ ] implement persistence and store logs for each node locally on disk
- [ ] implement leader management:
    - auto select leader (can be just a random node or the first node that sucessfully put its claim to link-kv)
